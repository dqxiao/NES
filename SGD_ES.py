...
class SGD_OES():
    ...
    def step(self, net, data, target, base):
        ...
        return loss_min[0], self.sigma,np.std(reward), c_momentum
...
#         b= -1*base
        ...
        return loss_min[0], self.sigma[1], np.std(reward), c_momentum

    
class SGD_PEPG_Var():
    # single g 
    # Entropy-based evolutionability enhanced version to get it quick
    def __init__(self,net,lr=0.001, momentum=0.99):
        self.lr = lr 
        self.v = {} # dict for recording 
